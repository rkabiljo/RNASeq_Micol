...
#out=trimmed/01_mus2_mit_S3_R1_001.fastq.gz ref=adapters.fa \
#threads=2 ktrim=r k=21 mink=11 minlen=25 hdist=1 tbo tpe 

#bbduk.sh -Xmx4g in=trimmed/01_mus2_mit_S3_R1_001.fastq.gz out=qual/01_mus2_mit_S3_R1_001.fastq.gz threads=2 qtrim=rl trimq=20 minlen=25          
